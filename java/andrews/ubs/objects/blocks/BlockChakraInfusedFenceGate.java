...
public class BlockChakraInfusedFenceGate extends BlockHorizontal implements IHasModel
{
    ...
    public BlockChakraInfusedFenceGate(String name)
    {
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        if (state.getBlock() instanceof BlockChakraInfusedFenceGate &&
