...
public class BlockAvocadoFenceGate extends BlockHorizontal implements IHasModel
{
    ...
    public BlockAvocadoFenceGate(String name)
    {
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        if (state.getBlock() instanceof BlockAvocadoFenceGate &&
