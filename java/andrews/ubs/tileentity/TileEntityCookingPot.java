...
public class TileEntityCookingPot extends TileEntity implements ITickable, ISidedInventory
{
...
//Get the name of this object. For players this returns their username
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.cooking_pot";
    }
...
//Sets the given item stack to the specified slot in the inventory (can be crafting or armor sections).
    public void setInventorySlotContents(int index, @Nullable ItemStack stack)
    {
		...
		{
			ItemStack stack1 = (ItemStack)this.furnaceItemStacks[index + 1];
...
//Like the old updateEntity(), except more generic.
        ...
        if (!this.worldObj.isRemote)
        {
            if (this.isBurning() || this.furnaceItemStacks[1] != null && this.furnaceItemStacks[0] != null)
            {
                ...
                if (this.isBurning() && this.canSmelt())
                {
                    ...
                    {
                        this.cookTime = 0;
                        this.totalCookTime = this.getCookTime(this.furnaceItemStacks[0], this.furnaceItemStacks[1]);
                        this.smeltItem();
                        flag1 = true;
                    }
                }
    ...
    public int getCookTime(@Nullable ItemStack stack, ItemStack stack1)
    {
        return 200;
    }
...
//Returns true if the furnace can smelt an item, i.e. has a source item, destination stack isn't full, etc.
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = FurnaceRecipes.instance().getSmeltingResult(this.furnaceItemStacks[3]);
