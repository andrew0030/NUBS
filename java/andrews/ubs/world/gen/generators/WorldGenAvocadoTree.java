...
{
	public static final IBlockState LOG = BlockInit.LOG.getDefaultState().withProperty(BlockUBSLog.VARIANT, UBSEnumHandler.EnumType.AVOCADO);
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockUBSLeaves.VARIANT, UBSEnumHandler.EnumType.AVOCADO);
