...
public class WorldGenAvocadoTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = UltimateBlockStormBlocks.log.getDefaultState().withProperty(BlockUBSLog.VARIANT, BlockUBSPlanks.EnumType.AVOCADO);
	public static final IBlockState LEAF = UltimateBlockStormBlocks.leaves.getDefaultState().withProperty(BlockUBSLeaves.VARIANT, BlockUBSPlanks.EnumType.AVOCADO);
	
    private final boolean useExtraRandomHeight;

    public WorldGenAvocadoTree(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
                        ...
                        if (k1 > 0)
                        {
                            ...
                            for (int i5 = -2; i5 <= 2; ++i5)
                            {
                                for (int k5 = -2; k5 <= 2; ++k5)
                                {
                                    if (Math.abs(i5) != 2 || Math.abs(k5) != 2)
                                    {
                                        ...
                                        this.placeLeafAt(worldIn, blockpos3.add(i5, -1, k5));
                                    }
                                }
                            }
                            ...
                            for (int j5 = -1; j5 <= 1; ++j5)
                            {
                                for (int l5 = -1; l5 <= 1; ++l5)
                                {
                                    ...
                                    this.placeLeafAt(worldIn, blockpos3.add(j5, -1, l5));
                                }
                            }
                        }
                    }
