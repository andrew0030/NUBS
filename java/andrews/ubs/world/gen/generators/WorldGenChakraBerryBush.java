...
public class WorldGenChakraBerryBush extends WorldGenerator implements IStructure
{
	public static String plantname;
	
	public WorldGenChakraBerryBush(String name) 
	{
		this.plantname = name;
	}
	...
	{
		this.generateChakraBerryBush(worldIn, position);
		return true;
	}
	
	public static void generateChakraBerryBush(World world, BlockPos pos)
	{
