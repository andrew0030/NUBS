...
public class WorldGenWildSalad extends WorldGenerator implements IStructure
{
	public static String plantname;
	
	public WorldGenWildSalad(String name) 
	{
		this.plantname = name;
	}
	...
	{
		this.generatePlant(worldIn, position);
		return true;
	}
	
	public static void generatePlant(World world, BlockPos pos)
	{
