...
{
	public static final IBlockState LOG = BlockInit.LOG.getDefaultState().withProperty(BlockUBSLog.VARIANT, UBSEnumHandler.EnumType.CHAKRA_INFUSED);
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockUBSLeaves.VARIANT, UBSEnumHandler.EnumType.CHAKRA_INFUSED);
