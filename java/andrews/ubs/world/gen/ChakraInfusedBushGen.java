...
public class ChakraInfusedBushGen implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
	{
		...
		case 0:
			...
			generateChakraInfusedBush(BUSH, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH1, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH2, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH3, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH4, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH5, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH6, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH7, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH8, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedBush(BUSH9, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
