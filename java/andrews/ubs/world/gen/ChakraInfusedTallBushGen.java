...
public class ChakraInfusedTallBushGen implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
	{
		...
		case 0:
			...
			generateChakraInfusedTallBush(TALLBUSH, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
			generateChakraInfusedTallBush(TALLBUSH1, world, random, chunkX, chunkZ, 1, BlockInit.CHAKRA_INFUSED_GRASS, BiomeChakraInfused.class);
