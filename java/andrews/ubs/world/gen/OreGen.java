...
//Set the Blocks for the Generators
	public OreGen() {
		salt_overworld = new WorldGenMinable(UltimateBlockStormBlocks.stone_salt.getDefaultState(), 5);
		salt_nether = new WorldGenMinable(UltimateBlockStormBlocks.nether_salt.getDefaultState(), 5, new NetherGenPredicate());
		chakra_ore = new WorldGenMinable(UltimateBlockStormBlocks.chakra_ore.getDefaultState(), 5);
		nether_chakra_ore = new WorldGenMinable(UltimateBlockStormBlocks.nether_chakra_ore.getDefaultState(), 5, new NetherGenPredicate());
		end_chakra_ore = new WorldGenMinable(UltimateBlockStormBlocks.end_chakra_ore.getDefaultState(), 5, new EndGenPredicate());
	}
