...
public class GuiNinjaAnimal extends GuiScreen
{
...
//		super.drawScreen(mouseX, mouseY, partialTicks);
		...
		drawTexturedModalRect(centerX - 37, centerY + 141, 0, 199, 37, 9);
		...
		mc.fontRenderer.drawString("Ninja Animals (WIP)", centerX + 4, centerY + 6, Color.BLACK.getRGB());
	}
