...
import andrews.ubs.handler.UltimateBlockStormLootTableHandler;
...
{
	private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(new Item[] {UltimateBlockStormItems.calamari, UltimateBlockStormItems.calamari_cooked});
...
//To get the LootTable
	...
	{
		return UltimateBlockStormLootTableHandler.CRAB;
	}
