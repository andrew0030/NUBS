...
public class UltimateBlockStormColorHandler
{
	...
	private static void registerBlockColourHandlers(final BlockColors blockColors)
	{
		...
		blockColors.registerBlockColorHandler(grassColourHandler, UltimateBlockStormBlocks.falling_trap_grass);
	}
	...
	private static void registerItemColourHandlers(final BlockColors blockColors, final ItemColors itemColors)
	{
		...
		/**
		 *No Item Needed for Block
		 */
//		itemColors.registerItemColorHandler(itemBlockColourHandler, UltimateBlockStormBlocks.falling_trap_grass);
	}
}