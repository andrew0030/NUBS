...
public class WaterWalkButton extends Gui
{
...
//To Load the stamina bar
	...
	public void onRenderGameOverlay(RenderGameOverlayEvent event) 
	{
		...
		{
		//To set the position
			int posX = event.getResolution().getScaledWidth() / 2 + 109;
			...
			{
				drawTexturedModalRect(posX, posY, 17, 0, tex_width, tex_height);
				drawTexturedModalRect(posX, posY, 17, 17, currentWidth, tex_height);
			}
			else if(mc.thePlayer.isCreative())
			{
				drawTexturedModalRect(posX, posY + 22, 17, 0, tex_width, tex_height);
				drawTexturedModalRect(posX, posY + 22, 17, 17, currentWidth, tex_height);
			}
		}
	}
}